...
public class SendMessagePanelGUI : PanelGuiBase {
	...
	private void OnGUI() {
		...
		var rect = new Rect((Screen.width - 480) / 2, (Screen.height - 300) / 2, 480f, 300f);
	...
	private void DoCompose(Rect rect) {
		...
		var num4 = 70;
		var num5 = 100;
		GUI.Label(new Rect(0f, 0f, rect2.width, 0f), LocalizedStrings.NewMessage, BlueStonez.tab_strip);
