	...
	public class PlayerCardView : IComparable {
		...
		public int CompareTo(object obj) {
			if (obj is PlayerCardView) {
				var playerCardView = obj as PlayerCardView;
		...
		public override string ToString() {
			return string.Concat("[Player: [Name: ", Name, "][Cmid: ", Cmid, "][Splats: ", Splats, "][Shots: ", Shots, "][Hits: ", Hits, "][Splatted: ", Splatted, "][Precision: ", Precision, "][Ranking: ", Ranking, "][TagName: ", TagName, "]]");
		}
	}
}
